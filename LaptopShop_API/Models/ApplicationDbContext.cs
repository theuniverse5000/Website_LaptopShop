...
namespace LaptopShop_API.Models
{
    public class ApplicationDbContext : DbContext
    {
        ...
        {
              optionsBuilder.UseSqlServer(@"Data Source=DESKTOP-3S9P0UC\SQLEXPRESS;Initial Catalog=LaptopShop_API;Persist Security Info=True;User ID=theuniverse;Password=theuniverse");
        }
