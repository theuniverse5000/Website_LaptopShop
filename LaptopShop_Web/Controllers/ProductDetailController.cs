...
namespace LaptopShop_Web.Controllers
{
    public class ProductDetailController : Controller
    {
        ...
        public async Task<IActionResult> Create()
        {
            ...
            var reponseCpu = await httpClient.GetAsync("https://localhost:44308/api/Cpu");
            var reponseRam = await httpClient.GetAsync("https://localhost:44308/api/Ram");
            var reponseHardDrive = await httpClient.GetAsync("https://localhost:44308/api/HardDrive");
            var reponseScreen = await httpClient.GetAsync("https://localhost:44308/api/Screen");
            var reponseProduct = await httpClient.GetAsync("https://localhost:44308/api/Product");
            var reponseColor = await httpClient.GetAsync("https://localhost:44308/api/Color");
            var reponseCardVGA = await httpClient.GetAsync("https://localhost:44308/api/CardVGA");
        ...
        public async Task<IActionResult> Create(ProductDetailView productDetailView)
        {
            ...
            using (var client = new HttpClient())
            {
                client.BaseAddress = new Uri("https://localhost:44308/api/ProductDetail");
