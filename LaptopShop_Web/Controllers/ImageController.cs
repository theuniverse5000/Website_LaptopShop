...
namespace LaptopShop_Web.Controllers
{
    public class ImageController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var reponsePro = await client.GetAsync("https://localhost:44308/api/ProductDetail");
            ...
            var reponse = await client.GetAsync("https://localhost:44308/api/Image");
        ...
        {
            HttpClient client = new HttpClient();
            var reponse = await client.GetAsync("https://localhost:44308/api/ProductDetail");
            string apiData = await reponse.Content.ReadAsStringAsync();
        ...
        public async Task<IActionResult> Create(Image obj, IFormFile imageFile, string maProductDetail)
        {
            ...
            client.BaseAddress = new Uri("https://localhost:44308/api/Image");
        ...
        {
            HttpClient client = new HttpClient();
            client.BaseAddress = new Uri($"https://localhost:44308/api/Image/id?Id={id}");
